...
#     "collection_name": "prefect-hex",
#     "collection_short_description": "Prefect integrations for Hex",  # noqa
# }
...
# )
# REPO_DIRECTORY = THIS_DIRECTORY / "prefect-hex"  # redirects repo_directory
...
populate_collection_repo(
    ...
    base_url="https://{tenant}.hex.tech/api/v1",
)
